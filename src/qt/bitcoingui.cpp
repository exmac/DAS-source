...
void BitcoinGUI::createActions()
{
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Das"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Das Core help message to get a list with possible Das command-line options"));
